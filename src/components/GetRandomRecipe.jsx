...
export const GetRandomRecipe = ({ protein, cuisine, popular, setPopular }) => {
  ...
  const getPopular = async () => {
    const response = await fetch(
      `https://api.spoonacular.com/recipes/complexSearch?${apiKey}&number=10&query=${cuisine}${protein}&maxAlcohol=0&offset=0`
    );
